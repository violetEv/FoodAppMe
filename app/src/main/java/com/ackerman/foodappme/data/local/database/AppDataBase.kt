package com.ackerman.foodappme.data.local.database
...
import com.ackerman.foodappme.data.local.database.AppDatabase.Companion.getInstance
...
import com.ackerman.foodappme.data.local.database.mapper.toMenuEntity
    ...
    private fun prepopulateCarts(): List<CartEntity> {
        return mutableListOf(
            CartEntity(
                id = 1,
                menuId = 1,
                itemNotes = "fresh food is okay",
                itemQuantity = 3
            ),
            CartEntity(
                id = 2,
                menuId = 2,
                itemNotes = "half portion only",
                itemQuantity = 6
            ),
        )
    }
